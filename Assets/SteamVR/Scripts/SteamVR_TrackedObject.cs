...
public class SteamVR_TrackedObject : MonoBehaviour
{
    ...
    private void OnNewPoses(params object[] args)
	{
		...
		{
            float x = trackX ? pose.pos.x : transform.localPosition.x;
            float y = trackY ? pose.pos.y : transform.localPosition.y;
            float z = trackZ ? pose.pos.z : transform.localPosition.z;
